                ...
                <div class="d-flex justify-content-center form_container">
                    <form class="account-form" id="sign_in" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input required type="text" name="name" class="form-control input_user" value=""
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input required type="text" name="phone" class="form-control input_user" value=""
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input required type="email" name="email" class="form-control input_user" value=""
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="password" required name="password_confirmation" class="form-control input_pass"
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" required name="address" class="form-control input_pass" value=""
                                placeholder="Address">
                            @error('address')
                                <span style="display: block;" class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
