...
Route::get('/computers', 'HomeController@services')->name('services');
...
Route::get('/rentit/{id?}', 'HomeController@checkout')->name('checkout_page')->middleware('auth');
...
Route::get('/computer_detail/{id?}', 'HomeController@service_detail')->name('single');
